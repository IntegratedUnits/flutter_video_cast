...
part 'src/modals/queue_item.dart';
part 'src/modals/MediaMetadata.dart';
part 'src/modals/medi_info.dart';
part 'src/modals/media_load_request_data.dart';
part 'src/modals/queue_data.dart';
